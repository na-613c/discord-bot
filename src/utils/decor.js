...
async function getDecorResponse(resources) {
    ...
    return [
        {
            sell: 0.9 * (40 * metal100.sell + 60 * copper100.sell + 100 * wires100.sell + 30 * plastic100.sell),
            buy: 0.9 * (40 * metal100.buy + 60 * copper100.buy + 100 * wires100.buy + 30 * plastic100.buy),
        },
        {
            sell: 0.9 * (80 * metal100.sell + 170 * copper100.sell + 150 * wires100.sell + 80 * plastic100.sell),
            buy: 0.9 * (80 * metal100.buy + 170 * copper100.buy + 150 * wires100.buy + 80 * plastic100.buy),
        },
        {
